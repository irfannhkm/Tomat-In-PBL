                ...
                <table class="w-full mt-4 border-collapse border border-gray-300 dark:border-gray-700">
                    <thead>
                        <tr class="bg-gray-100 dark:bg-gray-700">
                            ...
                            <th class="px-4 py-2 border text-left text-gray-800 dark:text-gray-100">Penyebab Penyakit</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="px-4 py-2 border text-gray-800 dark:text-gray-200 text-sm text-center">{{ $result['cause'] ?? '-' }}</td>
